...
def test_router_is_registered_and_reads_need_a_key():
    ...
    assert 'check_admin_or_module(request, "timesheets", ME_ZONE_MASTER, "me_plan_parttime", *extra)' in func_body(src, "def _who("), "2026-09-08 稽核：讀取從登入即可改成工作追蹤或今天與這週鑰匙（回整個在職名單＋工時）"

...
def test_creating_a_payout_never_touches_payment_status():
    ...
    """
    body = code_only(func_body(SRC, "async def create_payout("))
...
def test_revoking_only_clears_the_token():
    ...
    """
    body = code_only(func_body(SRC, "async def revoke_payout_share("))
...
def test_the_public_page_only_serves_the_whitelist_projection():
    ...
    """
    body = code_only(func_body(SRC, "async def payout_share_page("))

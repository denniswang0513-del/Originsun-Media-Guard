...
PUBLIC_SURFACES: List[dict] = [
    ...
    {"key": "payout", "label": "匯款通知", "who": "收款人（外包、同事）",
     "how": "/p/<短碼>（應付帳款面板按「匯款通知」鑄的；一次匯款一張）",
     "pages": ["payout.html"], "prefixes": ["/p/", "/api/v1/crm/public/payout/"], "modes": [MODE_OFF, MODE_LINK], "default": MODE_LINK},

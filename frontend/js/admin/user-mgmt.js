...
const ALL_MODULES = ['backup','verify','transcode','concat','report','transcribe','tts','projects','crm_clients','crm_projects','crm_quotes','crm_staff'];
const MODULE_LABELS = {backup:'備份',verify:'比對',transcode:'轉檔',concat:'串帶',report:'報表',transcribe:'逐字稿',tts:'語音',projects:'專案',crm_clients:'客戶',crm_projects:'專案管理',crm_quotes:'報價',crm_staff:'人力'};

...
function renderDetail(project) {
    ...
    document.getElementById('proj-detail-team').innerHTML = `
        <div id="proj-pay-ampm-src" style="display:inline-flex;gap:14px;align-items:center;">
            <span>AM <span class="pi-edit-cell" id="proj-am-display" data-field="am_username" onclick="window._projEdit(this)" style="cursor:pointer;display:inline-block;">${_amHtmlT}</span></span>
            <span>PM <span class="pi-edit-cell" id="proj-pm-display" data-field="pm_usernames" onclick="window._projEdit(this)" style="cursor:pointer;display:inline-block;">${_pmHtmlT}</span></span>
        </div>

...
import { _loadAgents, _loadAgentsNoPolling, _renderMachines, _updateMachineCard, _agents, _agentStatus, pausePolling, resumePolling, toggleAddAgent, addAgent, removeAgent } from './agent-cards.js';
import { _triggerAgentUpdate, _updateBatchButton, _batchUpdate, _updatingAgents } from './agent-update.js';
...
// Expose constants on window for agent-cards.js
...
// Expose _masterVersion on window for agent modules
Object.defineProperty(window, '_masterVersion', {
    get() { return _masterVersion; },
    set(v) { _masterVersion = v; },
    configurable: true,
});
...
// ── Version comparison (exported for agent-cards.js / agent-update.js) ──
export function _isNewer(remote, local) {
...
// ── XSS-safe text node helper (exported for agent-cards.js) ──
export function _text(str) {

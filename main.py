...
_ROUTER_MODULES = [
    ...
    'api_api_keys', 'api_timesheets', 'api_cashflow', 'api_finance', 'api_finance_stmt', 'api_finance_card', 'api_finance_assets', 'api_finance_projects', 'api_ledger_mobile', 'api_locations', 'api_proposals',
    'api_references',
    'api_intel',
    'api_portal',
...
async def _on_startup():
    # 開機 migration 的 SQL 全部住 db/migrations.py（只有資料）：索引、CREATE TABLE、ADD COLUMN 清單

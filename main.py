...
_ROUTER_MODULES = [
    ...
    'api_api_keys', 'api_timesheets', 'api_cashflow', 'api_finance', 'api_finance_stmt', 'api_finance_card', 'api_finance_assets', 'api_finance_projects', 'api_ledger_mobile', 'api_fortress', 'api_locations', 'api_proposals',
    'api_references',
    'api_intel',
    'api_portal',

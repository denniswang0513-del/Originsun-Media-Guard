...
| 財富階梯（owner 2026-09-16 拍板「參考市場先生」） | 門檻＝台灣最常見的算法：書裡的美金級距乘 30（30 萬／300 萬／3,000 萬），第 5 階「住宅自由」照市場先生拉到 **6 億**起跳（台灣買房特別貴），第 6 階 30 億。跟商周／經理人那些文章可以直接對照。曾試過「從台灣物價回推」的一百萬起跳版（比較嚴格，但沒有人那樣算、對照不上），當天換掉。淨值＝五層合計 − 負債（卡債＋貸款剩餘本金），**不含應收帳款、器材、房地產**（私帳沒有房產科目）。旁邊並排一行台灣分位數（主計總處 2021 年底：中位數 894 萬／前 20% 2,134 萬／前 10% 3,391 萬；🔴 那份統計八成以上是自住房產，拿純金融資產去比會低估）。門檻、免思考比例、分位數、註記全部可改（`ladder`）；規劃欄位 `plan`＝目標階梯（預設下一階，6 億）＋目標年份（預設 20），每年再投入沿用 `growth.annual_add`。 |

...
_DEFAULT_ROLES = [
    {"name": "admin",     "access_level": 3, "modules": ["backup","verify","transcode","concat","report","transcribe","tts","projects","crm_clients","crm_projects","crm_quotes"], "description": "系統管理員"},
    {"name": "producer",  "access_level": 2, "modules": ["backup","verify","report","transcode","concat","transcribe","projects","crm_clients","crm_projects","crm_quotes"],       "description": "製片"},
